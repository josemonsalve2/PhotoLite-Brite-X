...
-- Date:              Fri Apr 22 15:42:59 2016 (by Create and Import Peripheral Wizard)
...
entity user_logic is
  ...
  (
    ...
    --USER ports added here
		myMemOE  	 : out   std_logic;  -- Output enable (read enable)
		myMemWR  	 : out   std_logic;  -- Write enable

		myRamAdv 	 : out   std_logic;  -- Address valid
		myRamCS  	 : out   std_logic;  -- Enable Cellular RAM
		myRamClk 	 : out   std_logic;  -- Clock
		myRamCRE 	 : out   std_logic;  -- Control register enable
		myRamLB  	 : out   std_logic;  -- Access lower byte (7 downto 0)
		myRamUB  	 : out   std_logic;  -- Access upper byte (15 downto 8)
		myRamWait	 : out   std_logic;  -- Wait

		myMemAdr 	 : out   std_logic_vector (25 downto 0);  -- Cellular RAM Address
		myMemDB  	 : inout std_logic_vector (15 downto 0);  -- Cellular RAM Data Bus
...
architecture IMP of user_logic is
  ...
  --USER signal declarations added here, as needed for user logic
	...
	PORT(
		...
		RamUB  	 : out   std_logic;  -- Access upper byte (15 downto 0)
